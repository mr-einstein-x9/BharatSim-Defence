...
export const AGENT_TYPES: AgentTypeDef[] = [
  ...
  { type: 'Local Police', emoji: '👮', color: 'bg-indigo-800', dot: 'bg-indigo-400' },
  { type: 'Supply Chain', emoji: '🚚', color: 'bg-yellow-500', dot: 'bg-yellow-400' },
  { type: 'Civilians', emoji: '👥', color: 'bg-red-600', dot: 'bg-red-500' }
];
